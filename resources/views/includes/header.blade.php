        ...
        <div class="topbar-area">
            <div class="container">
                <div class="row rs-vertical-middle">
                    <div class="col-lg-2">
                        <div class="logo-part">
                            <a href="{{ route('home') }}"><img src="images/logo-dark.png" alt=""></a>
                        </div>
                    </div>
                        ...
                        <nav class="rs-menu">
                            <ul class="nav-menu">
                                            ...
                                            <div class="mega-menu-innner">
                                                <div class="single-megamenu">
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="active"><a href="{{ route('home') }}">Main Demo</a>
                                                        </li>
                                                ...
                                                <div class="single-megamenu">
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="{{ route('web_development') }}">Web Design
                                                                Agency</a></li>
                                                        <li><a href="index13.html">Branding Agency</a></li>
                                                        <li class="last-item"><a href="index14.html">Technology
                                                                Agency</a></li>
                                                    </ul>
                                                </div>
                                                <div class="single-megamenu">
                                                ...
                                                <div class="single-megamenu">
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a href="onepage9.html">Application Testing</a>
                                                        </li>
                                                        <li><a href="onepage10.html">IT Solution 03</a></li>
                                                        <li><a href="onepage11.html">Digital Agency Dark</a>
                                                        </li>
                                                        <li><a href="onepage12.html">Web Design Agency</a></li>
                                                        <li><a href="onepage13.html">Branding Agency</a></li>
                                                        <li class="last-item"><a href="onepage14.html">Technology
                                                                Agency</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                ...
                                <li class="menu-item-has-children">
                                    <a href="#">Services</a>
                                    <ul class="sub-menu">
                                        <li><a href="{{ route('software_development') }}">Medical Documentation</a>
                                        </li>
                                        <li><a href="{{ route('web_development') }}">Medical Billing</a> </li>
                                        <li><a href="{{ route('analytic_solutions') }}">Web Development</a> </li>
                                        <li><a href="{{ route('cloud_and_devops') }}">Digital Marketing</a></li>
                                        <li><a href="{{ route('product_design') }}">UI/UX Design</a> </li>
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="case-studies-style1.html">Case Studies Style 1</a>
                                                </li>
                                                <li><a href="case-studies-style2.html">Case Studies Style 2</a>
                                                </li>
                                                <li><a href="case-studies-style3.html">Case Studies Style 3</a>
                                                </li>
                                                <li><a href="case-studies-style4.html">Case Studies Style 4</a>
                                                </li>
                                                <li><a href="case-studies-style5.html">Case Studies Style 5</a>
                                                </li>
                                                <li><a href="case-studies-style6.html">Case Studies Style 6</a>
                                                </li>
                                                <li><a href="case-studies-style7.html">Case Studies Style 7</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="menu-item-has-children">
