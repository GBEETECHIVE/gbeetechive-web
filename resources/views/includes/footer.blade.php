                ...
                <div class="row">
                    <div class="col-lg-3 col-md-12 col-sm-12 footer-widget">
                        ...
                        <div class="textwidget pb-30">
                            <p>GBeeTechive is a digital solutions company delivering innovative technology, marketing, 
                               and healthcare support services to organizations worldwide.</p>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12">
                        ...
                        <p class="widget-desc">We denounce with righteous and in and dislike men who are so beguiled
                            and demo realized.</p>
                        <p>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row y-middle">
                    ...
                    <div class="col-lg-6">
                        <div class="copyright">
                            <p>� <span id="current-year">2026</span> Innovative Technology. Creative Solutions. Measurable Results. <a
                                    href="http://rstheme.com/">RSTheme</a></p>
                        </div>
                    </div>
                </div>
            </div>
