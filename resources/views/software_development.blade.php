     ...
     <div class="main-content">
         ...
         <div class="rs-breadcrumbs img2">
             <div class="breadcrumbs-inner text-center">
                 <h1 class="page-title">Medical Documentation</h1>
                 <ul>
                 ...
                 <div class="row align-items-center">
                     <div class="col-lg-6 pr-40 md-pr-15 md-mb-50">
                         <div class="sec-title4">
                             <span class="sub-text">Medical Documentation</span>
                             <h2 class="title">Comprehensive Medical Documentation Services</h2>
                             <div class="heading-line"></div>
                             <div class="desc desc-big">
                                 We offer accurate and secure medical documentation services, including 
                                 transcriptions, EHR documentation, and insurance billing. Our services are compliant 
                                 with HIPAA standards, ensuring confidentiality and efficiency.
                            </div>
                     ...
                     <div class="row">
                         ...
                         <div class="col-lg-4 md-mb-30">
                             <div class="services-item">
                                 ...
                                 <div class="services-content">
                                     <h3 class="services-title"><a href="web-development.html">First Growing Process</a>
                                     </h3>
                                     <p class="services-desc">
                                         At vero eos et accusamus etiusto odio praesentium.
                                     </p>
                 ...
                 <div class="row">
                     <div class="col-lg-6 pr-45 md-pr-15 md-mb-50">
                         <div class="choose-img">
                             <img src="images/3_3.png" alt="images">
                         </div>
                     </div>
                     <div class="col-lg-6">
                         ...
                         <div class="rs-skillbar style1 modify1">
                             <div class="cl-skill-bar">
                                 <!-- Start Skill Bar -->
                                 <span class="skillbar-title">Customized Solutions</span>
                                 <div class="skillbar" data-percent="92">
                                     <p class="skillbar-bar"></p>
                                     <span class="skill-bar-percent"></span>
                                 </div>
                                 <!-- Start Skill Bar -->
                                 <span class="skillbar-title">Affordable Pricing</span>
                                 <div class="skillbar" data-percent="80">
                                     <p class="skillbar-bar"></p>
                                     <span class="skill-bar-percent"></span>
                                 </div>
                                 <!-- Start Skill Bar -->
                                 <span class="skillbar-title">Expert Team </span>
                                 <div class="skillbar" data-percent="95">
                                     <p class="skillbar-bar"></p>
                                     <span class="skill-bar-percent"></span>
                                 </div>
                                 <!-- Start Skill Bar -->
                                 <span class="skillbar-title">Data Security</span>
             ...
             <div class="container">
                 <div class="rs-carousel owl-carousel" data-loop="true" data-items="5" data-margin="30"
                     ...
                     <div class="partner-item">
                         <div class="logo-img">
                             <a href="#">
                                 <img class="hover-logo" src="images/4.png" alt="">
                                 <img class="main-logo" src="images/4.png" alt="">
                             </a>
                         </div>
                     </div>
                     <div class="partner-item">
                         <div class="logo-img">
                             <a href="#">
                                 <img class="hover-logo" src="images/5.png" alt="">
                                 <img class="main-logo" src="images/5.png" alt="">
                             </a>
                         </div>
                     </div>
                     <div class="partner-item">
                         <div class="logo-img">
                             <a href="#">
                                 <img class="hover-logo" src="images/6.png" alt="">
                                 <img class="main-logo" src="images/6.png" alt="">
                             </a>
                         </div>
                     </div>
                     <div class="partner-item">
