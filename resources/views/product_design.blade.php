     ...
     <div class="main-content">
         ...
         <div class="rs-breadcrumbs img2">
             <div class="breadcrumbs-inner text-center">
                 <h1 class="page-title">UI/UX Design 
                 ...
                 <div class="row align-items-center">
                     <div class="col-lg-6 pr-40 md-pr-15 md-mb-50">
                         <div class="sec-title4">
                             <span class="sub-text">UI/UX Design</span>
                             <h2 class="title">Comprehensive UI/UX Services</h2>
                             <div class="heading-line"></div>
                             <div class="desc desc-big">
                                 Our user-centered design approach ensures engaging and intuitive digital experiences. 
                                 We deliver designs that look great and function flawlessly, from research and wireframing to interface design and usability testing.
                             </div>
