            ...
            <div class="row">
                <div class="col-lg-7 col-md-12 pr-140 md-mb-140 md-pr-15">
                    <div class="content-wrap">
                        <h1 class="it-title">Smart Digital Solutions That Drive Efficiency</h1>
                        <div class="description">
                            <p class="desc">
                                We transform businesses with innovative technology, creative design, 
                                and data-driven digital strategies tailored to your goals.
                            </p>
                        </div>
                        <div class="rs-videos">
                    ...
                    <div class="rs-contact">
                        <div class="contact-wrap">
                            <div class="content-part mb-25">
                                <h2 class="title mb-15">contact form</h2>
            ...
            <div class="row">
                <div class="col-lg-5 col-md-12 md-mb-50">
                    <div class="rs-animation-shape">
                        <div class="pattern">
                            <img src="images/about-part-1.png" alt="">
                        </div>
                        <div class="middle">
                            <img class="dance" src="images/about-part-2.png" alt="">
                        </div>
                        <div class="bottom-shape">
                            <img class="dance2" src="images/about-part-3.png" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-lg-7 col-md-12 pl-40 md-pl-15 md-pt-200 sm-pt-0">
                    <div class="sec-title mb-30">
                        <div class="sub-text">About the Company</div>
                        <h2 class="title pb-20">
                            We Empower Businesses With Innovative Technology
                        </h2>
                        <div class="desc pr-90 md-pr-0">
                            Description: Modern digital solutions are designed to accelerate growth, enhance efficiency, 
                            and strengthen your brand presence across industries.
                        </div>
                    </div>
    ...
    <div class="rs-services main-home gray-color pt-120 pb-120 md-pt-70 md-pb-70">
        <div class="container">
            <div class="sec-title2 text-center mb-45">
                <span class="sub-text"> Our Core Services</span>
                <h2 class="title">
            ...
            <div class="row">
                    ...
                    <div class="services-item">
                        <div class="services-icon">
                            <div class="image-part">
                                <img src="images/1.png" alt="Medical Documentation & Transcription">
                            </div>
                        </div>
                        <div class="services-content">
                            <div class="services-text">
                                <h3 class="#"><a href="Medical Documentation & Transcription.html">Medical Documentation & Transcription</a></h3>
                            </div>
                            <div class="services-desc">
                                <p>
                                    Accurate and secure medical documentation services, including transcription, 
                                    EHR records, and clinical reports, to ensure compliance and efficiency.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-25">
                    <div class="services-item">
                        <div class="services-icon">
                            <div class="image-part">
                                <img src="images/2.png" alt="Medical Billing Solutions">
                            </div>
                        </div>
                        <div class="services-content">
                            <div class="services-text">
                                <h3 class="services-title"><a href="Medical Billing Solutions.html">Medical Billing Solutions</a></h3>
                            </div>
                            <div class="services-desc">
                                <p>
                                    Complete billing management that reduces errors, speeds reimbursements, 
                                    and improves revenue cycles for healthcare providers.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 mb-25">
                    <div class="services-item">
                        <div class="services-icon">
                            <div class="image-part">
                                <img src="images/3.png" alt="Web Development">
                            </div>
                        </div>
                        <div class="services-content">
                            <div class="services-text">
                            ...
                            <div class="services-desc">
                                <p>
                                    Fast, responsive, and user-friendly websites built to match your business 
                                goals and deliver seamless digital experiences.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 md-mb-25">
                    <div class="services-item">
                        ...
                        <div class="services-content">
                            <div class="services-text">
                                <h3 class="services-title"><a href="digital-marketing.html">Digital Marketing</a>
                                </h3>
                            </div>
                            <div class="services-desc">
                                <p>
                                    Strategic marketing solutions that boost visibility, attract audiences, 
                                      and strengthen your brand’s online presence.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 sm-mb-25">
                    <div class="services-item">
                        <div class="services-icon">
                            <div class="image-part">
                                <img src="images/5.png" alt="UI/UX Design">
                            </div>
                        </div>
                        <div class="services-content">
                            <div class="services-text">
                                <h3 class="services-title"><a href="UI/UX Design.html">UI/UX Design</a></h3>
                            </div>
                            <div class="services-desc">
                                <p>
                                    User-focused designs that combine creativity and usability to deliver 
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="services-item">
                        ...
                        <div class="services-content">
                            <div class="services-text">
                                <h3 class="services-title"><a href="graphic-design.html">Graphic Design</a></h3>
                            </div>
                            <div class="services-desc">
                                <p>
                                     Professional visuals, including branding, logos, and marketing materials 
                                      that communicate your identity effectively.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="rs-contact-box text-center">
                        ...
                        <div class="sec-title3">
                            ...
                            <h2 class="title">Ready to Turn Your Ideas Into Reality?</h2>
                            <p class="desc">Our expert team is dedicated to understanding your 
                                needs and delivering innovative, tailored solutions that drive growth, efficiency, and success. 
                                Share your project details, and our specialists will get back to you shortly.</p>
                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-4  md-mb-40">
                    <div class="process-wrap bg3">
                        <div class="sec-title mb-30">
                            <div class="sub-text new">WHY CHOOSE US?</div>
                            <h2 class="title white-color">
                                Empowering Your Vision with Tailored Technology. 
                            </h2>
                        </div>
                        <div class="btn-part mt-40">
                        ...
                        <div class="col-md-6 mb-40">
                            <div class="rs-addon-number">
                                <div class="number-text">
                                    ...
                                    <p class="number-txt"> Every project is uniquely tailored to your business goals and audience needs.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 mb-40">
                            <div class="rs-addon-number">
                                <div class="number-text">
                                    ...
                                    <p class="number-txt"> High-quality services that deliver real value within your budget.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6 sm-mb-40">
                            <div class="rs-addon-number">
                                <div class="number-text">
                                    ...
                                    <p class="number-txt">Skilled professionals across design, development, marketing, and documentation. </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="rs-addon-number">
                                <div class="number-text">
                                    ...
                                    <p class="number-txt">We prioritize data privacy and security, ensuring your information is always protected.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="rs-project bg5 style1 pt-110 md-pt-80">
        <div class="container">
            <div class="sec-title2 text-center mb-45 md-mb-30">
                <span class="sub-text white-color">Our Portfolio </span>
                <h2 class="title white-color">
                    Showcasing Our Work & Success Stories
                </h2>
                <p class="desc white-color mt-20">
                At GbeeTechive, our portfolio highlights real-world projects where innovation 
                meets results. Explore our successful implementations across healthcare, 
                education, corporate, and digital platforms.
            </p>
            </div>
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true"
                ...
                <div class="project-item">
                    <div class="project-img">
                        <a href="case-studies-single.html"><img src="images/1_1.jpg" alt="images"></a>
                    </div>
                    <div class="project-content">
                        <h3 class="title"><a href="case-studies-single.html">Healthcare & Medical Solutions</a></h3>
                         <p class="black-color">
                            Secure and compliant medical billing, documentation, EHR support, 
                            and clinical documentation projects delivered for healthcare providers 
                            to improve accuracy, compliance, and revenue cycle efficiency.
                        </p>
                    </div>
                </div>
                <div class="project-item">
                    <div class="project-img">
                        <a href="case-studies-single.html"><img src="images/2_1.jpg" alt="images"></a>
                    </div>
                    <div class="project-content">
                        <h3 class="title"><a href="case-studies-single.html">Software & Web Development Projects</a></h3>
                        <p class="black-color">
                            Custom software, LMS integrations, CMS platforms, and high-performance 
                            websites built for government, education, nonprofit, and corporate 
                            sectors with scalable and user-friendly architecture.
                        </p>
                    </div>
                </div>
                <div class="project-item">
                    <div class="project-img">
                        <a href="case-studies-single.html"><img src="images/3_1.jpg" alt="images"></a>
                    </div>
                    <div class="project-content">
                        <h3 class="title"><a href="case-studies-single.html">Digital Marketing & Branding Projects</a></h3>
                        <p class="black-color">
                            Result-driven digital marketing campaigns, social media management, 
                            branding, and SEO strategies designed to increase visibility, 
                ...
                <div class="project-item">
                    <div class="project-img">
                        <a href="case-studies-style1"><img src="images/4_1.jpg" alt="images"></a>
                    </div>
                    <div class="project-content">
                ...
                <div class="project-item">
                    <div class="project-img">
                        <a href="case-studies-single.html"><img src="images/5.jpg" alt="images"></a>
                    </div>
                    <div class="project-content">
                ...
                <div class="project-item">
                    <div class="project-img">
                        <a href="case-studies-style1"><img src="images/6.jpg" alt="images"></a>
                    </div>
                    <div class="project-content">
            ...
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true"
                ...
                <div class="testi-item">
                    <div class="author-desc">
                        <div class="desc"><img class="quote" src="images/quote2.png" alt="">Capitalize on low
            ...
            <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true"
                ...
                <div class="blog-item">
                    <div class="image-wrap">
                        <a href="blog-details.html"><img src="images/1_2.jpg" alt=""></a>
                ...
                <div class="blog-item">
                    <div class="image-wrap">
                        <a href="blog-details.html"><img src="images/2_2.jpg" alt=""></a>
                        <ul class="post-categories">
                ...
                <div class="blog-item">
                    <div class="image-wrap">
                        <a href="blog-details.html"><img src="images/3_2.jpg" alt=""></a>
                        <ul class="post-categories">
                ...
                <div class="blog-item">
                    <div class="image-wrap">
                        <a href="blog-details.html"><img src="images/4_2.jpg" alt=""></a>
                        <ul class="post-categories">
                ...
                <div class="blog-item">
                    <div class="image-wrap">
                        <a href="blog-details.html"><img src="images/5_1.jpg" alt=""></a>
                        <ul class="post-categories">
                ...
                <div class="blog-item">
                    <div class="image-wrap">
                        <a href="blog-details.html"><img src="images/6_1.jpg" alt=""></a>
                        <ul class="post-categories">
                            <li><a href="blog-details.html">It Services</a></li>
                        </ul>
                    </div>
                ...
                <div class="partner-item">
                    <div class="logo-img">
                        <a href="https://rstheme.com">
                            <img class="hover-logo" src="images/1_1.png" alt="">
                            <img class="main-logo" src="images/1_1.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-item">
                    <div class="logo-img">
                        <a href="https://rstheme.com">
                            <img class="hover-logo" src="images/2_1.png" alt="">
                            <img class="main-logo" src="images/2_1.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-item">
                    <div class="logo-img">
                        <a href="https://rstheme.com">
                            <img class="hover-logo" src="images/3_1.png" alt="">
                            <img class="main-logo" src="images/3_1.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-item">
                    <div class="logo-img">
                        <a href="https://rstheme.com">
                            <img class="hover-logo" src="images/4_1.png" alt="">
                            <img class="main-logo" src="images/4_1.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-item">
                    <div class="logo-img">
                        <a href="https://rstheme.com">
                            <img class="hover-logo" src="images/5_1.png" alt="">
                            <img class="main-logo" src="images/5_1.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-item">
                    <div class="logo-img">
                        <a href="https://rstheme.com">
                            <img class="hover-logo" src="images/6_1.png" alt="">
                            <img class="main-logo" src="images/6_1.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-item">
                    <div class="logo-img">
                        <a href="https://rstheme.com">
                            <img class="hover-logo" src="images/7.png" alt="">
                            <img class="main-logo" src="images/7.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-item">
                    <div class="logo-img">
                        <a href="https://rstheme.com">
                            <img class="hover-logo" src="images/8.png" alt="">
                            <img class="main-logo" src="images/8.png" alt="">
                        </a>
                    </div>
                </div>
                <div class="partner-item">
                    <div class="logo-img">
                        <a href="https://rstheme.com">
                            <img class="hover-logo" src="images/9.png" alt="">
                            <img class="main-logo" src="images/9.png" alt="">
                        </a>
                    </div>
                </div>
            </div>
